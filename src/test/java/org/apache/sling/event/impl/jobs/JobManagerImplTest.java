...
public class JobManagerImplTest {
	...
	public JobManagerImpl getJobManager(int level) throws IllegalAccessException, NoSuchMethodException,
			SecurityException, IllegalArgumentException, InvocationTargetException {
	...
	private boolean logContainsLine(Predicate<String> matcher) throws IOException {
		try (BufferedReader reader = new BufferedReader(
				new InputStreamReader(new ByteArrayInputStream(this.outContent.toByteArray())))) {
			while (reader.ready()) {
