...
public class InventoryPluginTest extends JsonTestBase {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(mockScheduledJobInfo.getSchedules())
                .thenReturn(new ArrayList<>(Arrays.asList(mockScheduleInfo1, mockScheduleInfo2)));
        ...
        Mockito.when(mockQueueConfigurationManager.getMainQueueConfiguration())
                .thenReturn(mockMainInternalQueueConfiguration);
        ...
        Mockito.when(mockQueueConfigurationManager.getConfigurations())
                .thenReturn(new InternalQueueConfiguration[] {mockConfigInternalQueueConfiguration});
